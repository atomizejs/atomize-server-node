...
(function () {
    ...
    var atomize, cereal, http, sockjs, sockjs_opts, port, globalTVarCount, globalTVars, globalLocal, create, util;
    ...
    globalTVarCount = 1;
    globalTVars = {1: new TVar(1, false, {})};
    ...
    Client.prototype = {
        ...
        createUpdates: function (updates, txnId) {
            var keys, key, txnLog, localTVar, globalTVar, names, name, j, value, desc;
