...
(function () {
    ...
    Client.prototype = {
        ...
        commit: function (txnLog) {
            ...
            // Regardless of success, we always grab creates.  If we
            // read from, or wrote to any of the objs we created, we
            // will record in the txnlog that we read from or wrote to
            // version 0 of such objects. Thus we delay the bumping to
            // version 1 until now, and we then update ourself to
