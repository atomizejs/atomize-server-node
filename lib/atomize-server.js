                ...
                for (i = 0; i < localIds.length; i += 1) {
                    ...
                    for (j = 0; j < names.length; j += 1) {
                        ...
                        if (util.hasOwnProp.call(desc, 'tvar')) {
                            ...
                            // JSON.stringify loses fields with undefined values. GRR
                            if (util.hasOwnProp.call(desc, 'undefined')) {
                                desc.value = undefined;
                                delete desc['undefined'];
                            }
            ...
            while (0 < globalIds.length) {
                ...
                if (util.hasOwnProp.call(unpopulateds, globalId)) {
                    ...
                    for (i = 0; i < names.length; i += 1) {
                        ...
                        if (undefined === desc.value || null === desc.value) {
                            desc['undefined'] = true;
                            delete desc.value;
                            localTVar.value[name] = desc;
                        } else if (util.hasOwnProp.call(desc.value, 'tvar')) {
                            localTVar.value[name] = desc;
